...
const testimonials = [
  {
    ...
    content:
      "The Use of Shoppa made by my Products Selling increased due to use of shoppa through listing down my products and now am selling more than $500k per month.",
  },
  {
    name: "Alex",
...
const Testimonials = () => {
  ...
  // Rotation levels for bending cards
  const rotationLevels = [-3, -1, 1, 3];
      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">
            Explore how businesses and individuals have achieved their goals
            with our tailored solutions and exceptional support.
          </p>
          ...
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              whileHover={{
                y: -8,
                rotate: 0,
                transition: { duration: 0.15, ease: "easeOut" }, // fast hover animation
              }}
